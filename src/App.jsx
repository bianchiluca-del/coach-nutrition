Warning: truncated output (original token count: 73417)
Total output lines: 5386
...
const ActionProposalCard = ({ action, idx, plan, remaining, onApply, onRefuse, onAlternative }) => {
  ...
  return (
    <div className={`bg-white r…23417 tokens truncated…90 transition-opacity">＋ Ajouter un bilan</button>
